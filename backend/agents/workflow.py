...
workflow.add_edge("document_validation_node", "credit_scoring_node")
workflow.add_edge("credit_scoring_node", "policy_retrieval_node")
workflow.add_edge("policy_retrieval_node", "recommendation_node")
